package com.thaca.cms.enums;

import com.thaca.common.validations.ErrorMessageRule;
import lombok.Getter;

@Getter
public enum CmsErrorMessage implements ErrorMessageRule {
    ...
    CmsErrorMessage(String code, String titleVi, String messageVi, String titleEn, String messageEn) {
        this.code = code;

...
public interface CmsClient {
    @FwInternalApi(path = "/admin/tenants/all", name = ServiceMethod.CMS_GET_ALL_TENANTS)
    List<TenantInfoPrj> getAllTenants();

    @FwInternalApi(path = "/admin/tenants/get-by-ids", name = ServiceMethod.CMS_GET_TENANTS_BY_IDS)
    List<TenantInfoPrj> getTenantsByIds(TenantDTO request);

    @FwInternalApi(path = "/admin/tenants/get-full-by-ids", name = ServiceMethod.CMS_GET_TENANTS_FULL_BY_IDS)
    List<TenantDTO> getTenantsFullByIds(TenantDTO request);

    @FwInternalApi(path = "/admin/tenants/get", name = ServiceMethod.CMS_GET_TENANT)

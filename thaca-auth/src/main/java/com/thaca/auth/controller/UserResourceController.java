...
public class UserResourceController {
    ...
    public ResponseEntity<ApiPayload<UserDTO>> updateUser(@RequestBody ApiPayload<UserDTO> payload) {
        UserDTO updatedUser = userService.updateUser(payload.getBody().getData());
